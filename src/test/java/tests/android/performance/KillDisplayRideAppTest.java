...
public class KillDisplayRideAppTest extends BaseTest {
    ...
    public void killingApplication(String riderNameValue) {
        mv.inputNameIntoField(riderNameValue);
        mv.displayNowTap();
        mv.gettingNameFromNameField();
        mv.getContentFromTextPreviewFrameArray();
        assertTrue(mv.verifyNameIsPresentedInMessageFrame(), "The connection is not established after relaunching app of DisplayRide, name is not transmitted.");
