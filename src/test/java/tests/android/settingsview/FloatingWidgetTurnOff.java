...
public class FloatingWidgetTurnOff extends BaseTest {
    ...
    public void verifyThatFloatingWidgetTurnOff() {

        //Turn on Floating Widget
        sv.floatingWidgetTurnOff();

        //Check the Floating Widget Status
        assertEquals(sv.getCheckedStatusUiElement(sv.floatingWidgetSwitch), "false");
        ...
        //TODO SL Make Assert that Floating Widget will to show up
    }
